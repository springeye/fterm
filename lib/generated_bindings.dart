...
class NativeLibrary {
  ...
  ffi.Pointer<ffi.Int> test() {
    return _test();
  }

  late final _testPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Int> Function()>>('test');
  late final _test = _testPtr.asFunction<ffi.Pointer<ffi.Int> Function()>();

  void test2(
    ffi.Pointer<ffi.Int> conn,
  ) {
    return _test2(
      conn,
    );
  ...
  late final _test2Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Int>)>>(
          'test2');
  late final _test2 =
      _test2Ptr.asFunction<void Function(ffi.Pointer<ffi.Int>)>();
}
