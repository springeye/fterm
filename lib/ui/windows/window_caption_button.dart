...
class WindowCaptionButton extends StatefulWidget {
  ...
  WindowCaptionButton.close({
    ...
    this.icon,
    this.onPressed,
  })  : iconName = Assets.images.icChromeClose.path,
  ...
  WindowCaptionButton.unmaximize({
    ...
    this.icon,
    this.onPressed,
  })  : iconName = Assets.images.icChromeUnmaximize.path,
        super(key: key);
  ...
  WindowCaptionButton.maximize({
    ...
    this.icon,
    this.onPressed,
  })  : iconName = Assets.images.icChromeMaximize.path,
        super(key: key);
  ...
  WindowCaptionButton.minimize({
    ...
    this.icon,
    this.onPressed,
  })  : iconName = Assets.images.icChromeMinimize.path,
        super(key: key);
